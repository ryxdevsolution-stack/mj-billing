-- ========================================
-- COMPLETE GRANULAR PERMISSIONS (115 Total)
...
ON CONFLICT (permission_name) DO UPDATE SET description = EXCLUDED.description, category = EXCLUDED.category;

-- Billing View Permissions (5)
INSERT INTO permissions (permission_id, permission_name, description, category, created_at)
VALUES
...
-- Client Management - Super Admin (7)
INSERT INTO permissions (permission_id, permission_name, description, category, created_at)
VALUES
...
-- Payment Types Permissions (6)
INSERT INTO permissions (permission_id, permission_name, description, category, created_at)
VALUES
    (gen_random_uuid(), 'payment_types.view', 'View payment types page', 'Payment Types', NOW()),
    (gen_random_uuid(), 'payment_types.view_all', 'View all payment types', 'Payment Types', NOW()),
    (gen_random_uuid(), 'payment_types.create', 'Create new payment types', 'Payment Types', NOW()),
    (gen_random_uuid(), 'payment_types.edit', 'Edit payment type settings', 'Payment Types', NOW()),
    (gen_random_uuid(), 'payment_types.delete', 'Delete payment types', 'Payment Types', NOW()),
    (gen_random_uuid(), 'payment_types.set_default', 'Set default payment type', 'Payment Types', NOW())
ON CONFLICT (permission_name) DO UPDATE SET description = EXCLUDED.description, category = EXCLUDED.category;
...
-- Admin Dashboard Permissions (5)
INSERT INTO permissions (permission_id, permission_name, description, category, created_at)
VALUES
    (gen_random_uuid(), 'admin.dashboard.view', 'View admin dashboard', 'Admin Dashboard', NOW()),
    (gen_random_uuid(), 'admin.dashboard.view_metrics', 'View system-wide metrics', 'Admin Dashboard', NOW()),
    (gen_random_uuid(), 'admin.dashboard.view_users', 'View user statistics', 'Admin Dashboard', NOW()),
    (gen_random_uuid(), 'admin.dashboard.view_revenue', 'View revenue analytics', 'Admin Dashboard', NOW()),
    (gen_random_uuid(), 'admin.dashboard.export', 'Export admin dashboard data', 'Admin Dashboard', NOW())
ON CONFLICT (permission_name) DO UPDATE SET description = EXCLUDED.description, category = EXCLUDED.category;
...
-- ========================================
-- VERIFICATION: Should show 115 total
-- ========================================
