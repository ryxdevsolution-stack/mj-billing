  ...
  return (
    <div className="bg-white rounded-xl border-2 border-slate-200 shadow-md overflow-hidden">
      <div className="animate-pulse">
        {/* Table Header */}
        <div className="bg-gradient-to-r from-slate-200 to-slate-100 px-4 py-4">
        ...
        {Array.from({ length: rows }).map((_, index) => (
          <div key={index} className="border-t border-slate-200 px-4 py-4">
            <div className="flex gap-4">
  ...
  return (
    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
      {Array.from({ length: count }).map((_, index) => (
        <div key={index} className="bg-white rounded-xl border-2 border-slate-200 shadow-md p-5">
          <div className="animate-pulse">
...
export function ReportSkeleton() {
  return (
    <div className="bg-white rounded-2xl shadow-xl border border-slate-200 overflow-hidden">
      <div className="animate-pulse">
        {/* Header */}
        <div className="bg-gradient-to-r from-slate-200 to-slate-100 px-6 py-5">
        ...
        <div className="p-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
            {Array.from({ length: 2 }).map((_, index) => (
              <div key={index} className="bg-slate-50 rounded-xl p-5 h-80">
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 xs:grid-cols-2 lg:grid-cols-4 gap-4">
        {Array.from({ length: 4 }).map((_, index) => (
          <div key={index} className="bg-white rounded-lg shadow-md p-5 border border-slate-200">
            <div className="animate-pulse">
              <div className="h-3 bg-slate-200 rounded w-24 mb-3"></div>
              <div className="h-8 bg-slate-200 rounded w-32"></div>
            </div>
      ...
      <div className="bg-white rounded-lg shadow-md p-6 border border-slate-200">
        <div className="animate-pulse">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            {Array.from({ length: 4 }).map((_, index) => (
              <div key={index} className="h-32 bg-slate-100 rounded-lg"></div>
            ))}
          </div>
        </div>
      </div>
